...
static uint32_t gemm_A_dram [64]  __attribute__((section(".data")))  = { [0 ... 63] = 1 };
static uint32_t gemm_B_dram [64]  __attribute__((section(".data")))  = { [0 ... 63] = 2 };
static uint32_t gemm_C_dram [64]  __attribute__((section(".data")))  = { [0 ... 63] = 3 };