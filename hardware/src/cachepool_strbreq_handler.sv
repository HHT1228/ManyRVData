...
// Modified: added a flag to indicate whether the read is for strb handling or not
// Fake read requests (not from core) should not trigger coherence operation

`include "common_cells/registers.svh"

module cachepool_strbreq_handler #(
	// Data width
